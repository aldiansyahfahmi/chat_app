...
class $AssetsImagesIconsDialogGen {
  const $AssetsImagesIconsDialogGen();

  /// File path: assets/images/icons/dialog/failed.svg
  SvgGenImage get failed =>
      const SvgGenImage('assets/images/icons/dialog/failed.svg');

  /// File path: assets/images/icons/dialog/success.svg
  SvgGenImage get success =>
      const SvgGenImage('assets/images/icons/dialog/success.svg');

  /// List of all assets
  List<SvgGenImage> get values => [failed, success];
}
